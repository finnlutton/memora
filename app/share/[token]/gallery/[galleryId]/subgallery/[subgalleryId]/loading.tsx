// Streamed shell for a public shared subgallery view. The page handler
// awaits a 4-query data fetch before any HTML can render; without this
// file the visitor stares at a blank document for that interval. The
// shimmer mirrors the real page's title block + 2-column photo grid.

export default function PublicSharedSubgalleryLoading() {
  return (
