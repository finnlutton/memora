        ...
        <div className="absolute inset-x-0 bottom-0 px-5 pb-10 md:px-12 md:pb-16 lg:px-16 lg:pb-20">
          <div className="max-w-[44rem]">
            ...
            <p className="mt-5 max-w-[34rem] text-[14px] leading-6 text-white/82 md:mt-6 md:text-[15px] md:leading-7">
              In this era of fast-paced content, Memora offers a private, quiet platform to store and organize your experiences, add layers of written content, and share them with the people you care about. Through this, we hope to restore authenticity and reflection to the moments that deserve them.
            </p>
